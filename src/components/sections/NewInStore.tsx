...
const newProducts = [
  ...
  },
  {
    ...
    hoverImage: "https://1hairstop.in/cdn/shop/files/2clip-Invisi-light-coverup-patch_2.jpg",
    rating: 5,
    reviews: 6,
  },
];
...
export function NewInStore() {
  const productSlides = newProducts.map(product => (
  ...
  return (
    <section className="py-16 bg-white">
      <div className="max-w-8xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        {/* Desktop View */}
        <div className="hidden md:grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4">
          {productSlides}
        </div>

        {/* Mobile Slider */}
        <div className="md:hidden">
          <MobileSlider items={productSlides} />
        </div>
